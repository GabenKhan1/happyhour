...
import 'package:happy_hour/data/models/hour_favorite_model.dart';
import 'package:happy_hour/global_widgets/hour_card.dart';
...
class HoursListGenerator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //  FirestoreListView<HoursFavoriteModel>(
    //   query: query,
    //   shrinkWrap: true,
