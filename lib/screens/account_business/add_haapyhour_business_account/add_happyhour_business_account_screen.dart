...
import 'package:happy_hour/global_widgets/upload_Image_card.dart';
import 'package:happy_hour/screens/account_business/add_haapyhour_business_account/add_manually.dart';
            ...
            child: Form(
              ...
              child: ListView(
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(() => const AddHappyHourBusinessManually());
                    },
                    child: const Center(
                      child: Text(
                        "Add Manually",
