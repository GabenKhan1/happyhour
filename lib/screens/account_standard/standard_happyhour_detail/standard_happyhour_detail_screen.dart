                  ...
                  share: GestureDetector(
                    onTap: () {
                      Get.find<GlobalGeneralController>().upgradeAccountDialog(
                          ...
                          () {
                            //Account Upgrade Wil be Added
                            // Get.find<AuthController>().user.isBusiness == false ?
                            Get.find<AuthController>().user.uid.isEmpty
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: CustomReplyCard(
                subtitle:
                    controller.happyHour.reviewStar?[index]['reviewText'] ?? "",
                image: "assets/icons/Group 8.png",
                time: "5421",
                rating: "assets/icons/Path 16148.svg",
                //*in Custom Reply card reply Design is Implementd By boolean
